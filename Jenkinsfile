        ...
        stage('ssh docker pull & run') {
            ...
            steps {
                ...
                sshagent(['jenkins-deploy']) {
                    ...
                    sh "ssh -o StrictHostKeyChecking=no root@10.41.152.227 docker ps -q --filter name=${params.projectName} | grep -q . && docker rm -f name=${params.projectName} || echo Not Found"
